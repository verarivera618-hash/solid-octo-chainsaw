 ...
 */
export class PocketOptionDataProvider {
    name = 'Pocket Option';
    config;
    constructor(config = {}) {
        this.config = {
    ...
    generateMockBinaryData(symbol, startDate, endDate) {
        const data = [];
     ...
     */
    async getBinaryOptionData(symbol, expiryMinutes = 5) {
        const now = new Date();
...
//# sourceMappingURL=PocketOptionDataProvider.js.map