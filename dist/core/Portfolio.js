...
export class Portfolio {
    ...
    updatePosition(trade) {
        ...
        if (trade.side === 'buy') {
            ...
            if (currentPosition) {
                ...
                const newAveragePrice = this.calculateAveragePrice(currentPosition.quantity, currentPosition.averagePrice, trade.quantity, trade.price);
    ...
    calculateAveragePrice(currentQuantity, currentPrice, newQuantity, newPrice) {
